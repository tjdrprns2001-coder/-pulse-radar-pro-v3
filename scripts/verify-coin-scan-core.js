...
const reentry=core.classifyV2({dataState:'live',priceChange24h:14,priceChange1h:1.4,priceChange15m:.5,structure:'bullish',takerRatio:1.12,strategyCycle:{reentryEligible:true,reentryScore:82,best:{label:'이평 눌림·재회복',stage:'RETEST_HOLD'},reasons:['급등 후 눌림','20이평 재회복']}});
...
assert.notEqual(reentrySignal.level,'제외','validated re-entry must not be blocked only because the coin surged before');
