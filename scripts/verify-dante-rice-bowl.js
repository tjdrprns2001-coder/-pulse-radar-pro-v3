...
function params(){return{
  ...
  base:{minBars:4,preferredDurationRatioMin:1.2,preferredDurationRatioMax:2,maxRangeAtr:20,maxEma224SlopeAbsAtrPerBar:10},
  breakout:{level:'EMA224_OR_GONGGURI',breakoutBufferAtr:.05,minRvol:1.1,ignitionRvol:2,requireConfirmedClose:true},
  retest:{toleranceAtr:.5,reclaimBufferAtr:.02,minHoldBars:1,maxRetestBars:8},
