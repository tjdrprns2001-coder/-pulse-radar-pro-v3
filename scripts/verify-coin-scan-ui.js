...
assert(css.includes('.classMore')&&css.includes('content-visibility:auto'),'progressive per-class rendering styles required');
assert(js.includes('CLASS_PAGE_SIZE=12')&&js.includes('data-class-more'),'per-class progressive rendering required');
assert(/\/ui\/coin-scan\.js\?v=20260926-restore2/.test(html),'official v3 scanner UI must use current cache-bust');
