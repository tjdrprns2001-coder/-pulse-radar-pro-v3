...
assert(/\/ui\/coin-scan\.js\?v=20260925-ko1/.test(html),'official v3 scanner UI must use current cache-bust');
for(const s of ['v3Markup','장기 1W','정렬','테이커 매수/매도','상대거래량 1H','5분 참고','이평 배열 1H','인과성 ICT','봉 부족','인과성 규칙','근접 PD구간','정밀검사'])assert(js.includes(s)||html.includes(s),`official v3 flow UI missing ${s}`);
