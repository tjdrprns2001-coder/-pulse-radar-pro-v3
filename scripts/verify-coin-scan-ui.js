...
assert(/\/ui\/coin-scan\.js\?v=20260923-v3/.test(html),'official v3 scanner UI must use current cache-bust');
for(const s of ['v3Markup','장기 1W','정렬','true taker','RVOL 1H','5m 참고','EMA/SMA 1H','근접 PD','정밀검사'])assert(js.includes(s)||html.includes(s),`official v3 flow UI missing ${s}`);
