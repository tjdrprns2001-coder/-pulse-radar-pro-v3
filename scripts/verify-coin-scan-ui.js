...
for(const s of ['CLASS_PAGE_SIZE=12','evidenceText','data_gaps','conflicted','fresh=1&run=','sourceWarning'])assert(js.includes(s)||html.includes(s),`scanner audit protection missing ${s}`);
...
assert(/\/ui\/coin-scan\.js\?v=20260925-audit1/.test(html),'official v3 scanner UI must use current cache-bust');
