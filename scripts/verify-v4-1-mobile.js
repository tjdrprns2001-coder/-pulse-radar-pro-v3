...
assert(scan.includes('/ui/coin-scan.css?v=20260926-restore2'),'scanner CSS cache-bust missing');
assert(scan.includes('/ui/coin-scan.js?v=20260926-restore2'),'scanner JS cache-bust missing');
