...
assert(shell.includes('/ui/pulse-shell.js?v=20260921-v5'),'V5 shell JS cache-bust missing');
...
assert(scan.includes('/ui/coin-scan.css?v=20260921-v5'),'scanner CSS cache-bust missing');
