...
let s=base();
s[348]={...s[348],close:99,ma224:100};
...
let s2=base();s2[348]={...s2[348],close:99};s2[349]={...s2[349],close:101};
...
// strict gate failure
let bad=base();bad[300]={...bad[300],close:101};bad[348]={...bad[348],close:99};bad[349]={...bad[349],close:101};
...
let cseries=base(370);cseries[348]={...cseries[348],close:99};cseries[349]={...cseries[349],close:105,high:106,low:104};
...
let late=base(370);late[348]={...late[348],close:99};late[349]={...late[349],close:105};
