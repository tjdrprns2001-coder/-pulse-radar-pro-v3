...
must(js.includes('if(validated.length)return validated')&&js.includes("state.finderPreset==='validated'?'balanced'"),'validated finder must fall back to core ranking when external validation is sparse');
