...
assert(html.includes('id="scanMethod"')&&html.includes('value="manus"')&&html.includes('value="perplexity"'),'scan method selector missing');
...
console.log('astra/manus/perplexity wiring verification passed');
