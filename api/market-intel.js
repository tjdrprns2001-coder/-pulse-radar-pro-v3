...
let singleton=null;
function defaultService(){if(!singleton)singleton=createMarketIntelService({coinGecko:createCoinGeckoProvider({}),coinMarketCap:createCoinMarketCapProvider({})});return singleton}
