...
function ensure(){if(document.getElementById('pulseResearchActions'))return;const style=document.createElement('style');style.textContent='.pulseResearchActions{position:sticky;bottom:8px;z-index:50;display:flex;gap:6px;flex-wrap:wrap;padding:8px;margin:10px;background:#081522e8;border:1px solid #29415c;border-radius:12px;backdrop-filter:blur(12px)}.pulseResearchActions a{color:#dfeeff;text-decoration:none;background:#10243a;border:1px solid #315174;border-radius:9px;padding:7px 9px;font:700 10px system-ui}.pulseResearchActions a.primary{background:#1557b8;border-color:#2c79e8}@media(max-width:650px){.pulseResearchActions{position:fixed;left:4px;right:4px;bottom:6px;margin:0}.pulseResearchActions a{flex:1;text-align:center;min-width:76px}}';document.head.appendChild(style);const box=document.createElement('div');box.id='pulseResearchActions';box.className='pulseResearchActions';document.body.appendChild(box);render()}
