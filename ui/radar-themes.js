(function(g){
  ...
  const PRIMARY_PRIORITY=['Stablecoin','L1','L2','AI','MEME','RWA','Gaming','DePIN','Privacy','NFT','SocialFi','DEX','Lending','Liquid Staking','Restaking','Oracle','Storage','Payments','Exchange Token','Perp DEX','Launchpad','DeFi','BTC Ecosystem','Solana Ecosystem','Base Ecosystem','Ethereum Ecosystem'];
