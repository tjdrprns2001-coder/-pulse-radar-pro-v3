...
function pct(entry,v){return entry>0&&v!=null?((v/entry)-1)*100:null}
...
function evaluateEvent({event,futureBars}={}){
  ...
  const high6=maxWithin(HORIZONS.h6),high24=maxWithin(HORIZONS.h24);
  const labels={
    Hit_6H_8pct:high6!=null?high6>=entry*1.08:null,
    Hit_24H_12pct:high24!=null?high24>=entry*1.12:null
  };
