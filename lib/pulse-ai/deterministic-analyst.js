...
function rowScore(row,candidateSet){
  ...
  if(candidateSet.has(row.symbol))s+=18;
...
module.exports={VERSION,n,pct,cleanSymbol,isExtended,topCandidates,extendedLeaders,sectorRows,marketPulse,dataQuality,focusSymbol,researchSnapshot,summaryText,deterministicAnswer,snapshot};
