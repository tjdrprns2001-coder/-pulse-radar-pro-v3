...
function createMemoryStore(){
  const snapshots=new Map(),outcomes=new Map(),checkpoints=new Map(),alerts=new Map(),evidence=new Map(),health=new Map(),states=new Map(),transitionSnapshots=new Map();
  return{
