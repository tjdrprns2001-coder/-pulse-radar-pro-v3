...
function snapshotFromItem(item={},context={}){
  ...
  return{
    id:['sampling-v3.2',symbol,hourBucket].join(':'),version:VERSION,samplingRevision:String(alt.revision||'3.2'),source:'AUTO_SCAN_PRE_OUTCOME',symbol,capturedAt,hourBucket,
