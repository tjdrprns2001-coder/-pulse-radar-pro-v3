...
function snapshotFromItem(item={},context={}){
  ...
  return{
    ...
    alternativeBars:{
      ...
      thresholdMode:String(alt.policy?.thresholdMode||''),thresholdScope:String(alt.policy?.thresholdScope||''),tickDefinition:String(alt.policy?.tickDefinition||''),overshootPolicy:String(alt.policy?.overshootPolicy||''),sourceSchema:alt.sourceSchema||null,
