...
function snapshotFromItem(item={},context={}){
  ...
  return{
    id:['sampling-v3.1',symbol,hourBucket].join(':'),version:VERSION,source:'AUTO_SCAN_PRE_OUTCOME',symbol,capturedAt,hourBucket,
    ...
    alternativeBars:{
      status:String(alt.status||'NOT_REQUESTED'),tradeCount:finite(alt.tradeCount)??0,
