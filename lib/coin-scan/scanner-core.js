...
function buildTradeSignal(input={}){
  ...
  const level=strongContext&&confirmations>=4&&confidence>=80?'매수 후보':confidence>=35&&confirmations>=2?'관찰':'제외';
...
module.exports={CATEGORY_ORDER,BLOCKED_STATES,filterUniverse,fastScore,classify,buildTradeSignal,beginnerSummary,isLeveragedBase};
