...
function analyze({frames={},priceChange24h=null,priceChange1h=null,priceChange15m=null,structure='neutral',momentumSignals=null,takerRatio=null,oiChangePct=null,trueCvd=null}={}){
  ...
  return{version:VERSION,stage,reentryEligible,patternEligible,reentryScore,priorSurge,cooled,reset,flowOk,impulse,entryTiming,breakoutStates:breakoutStates.slice(0,6),activeTracks:active.slice(0,10),best:active[0]||null,reasons:reasons.slice(0,8),timeframes:tfResults,bookManual};
}
