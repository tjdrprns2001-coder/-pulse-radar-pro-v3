...
function analyzeSamplePattern({frames={},derivativesProfile={}}={}){
  ...
  const similarity=Library.compareSampleLibrary({archetype:archetypeInfo.archetype,sweepKey:sweep.key,time15Key:timeSymmetry.m15.tag,time1hKey:timeSymmetry.h1.tag,resetKey:resetReignition.key,cleanup,xoi,takerExtreme,maClusterKey:maCluster.key,volumeStage:volumeMaDna.stage,flowType:flowType.key,htfTransition:maCluster.transition},3);
