...
function screen(row={},opts={}){
  ...
  if(hardRejectReasons.includes('UPSTREAM_VALIDATION_REJECTED')||hardRejectReasons.includes('SPREAD_HARD_LIMIT')||hardRejectReasons.includes('SLIPPAGE_HARD_LIMIT')||hardRejectReasons.includes('DEPTH_HARD_LIMIT'))classification='REJECTED';
