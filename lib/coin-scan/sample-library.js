...
const SAMPLE_LIBRARY=Object.freeze([
  ...
  {name:'PTB',label:'PTB · OI-led 중립 taker 재압축 재점화형',expected:{archetype:['A','A+B','B'],maCluster:['TIGHT','NEAR','WIDE'],volumeStage:['IGNITION','EXPANSION','PRE_SPARK'],flowType:['DIRECT_BUILD','OBSERVE','ABSORPTION'],htfTransition:['LTF_LEADS_HTF','HTF_ALIGNED'],takerExtreme:false}}
]);
