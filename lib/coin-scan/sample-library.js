...
const SAMPLE_LIBRARY=Object.freeze([
  ...
  {name:'TAKE',label:'TAKE · taker 선행→거래량/OI 동시점화형',expected:{archetype:['A','A+B','B'],volumeStage:['PRE_SPARK','IGNITION','EXPANSION'],flowType:['DIRECT_BUILD','PRICE_LED'],htfTransition:['LTF_LEADS_HTF','HTF_ALIGNED'],takerExtreme:true},observed:{sampledAt:'2026-09-23',source:'Binance USDT perpetual',dna:'TAKE_TAKER_OI_IGNITION',compressionPrice:'0.060~0.061',triggerTaker:[1.6425,1.6312],onset1hRvol:42.73,preIgnitionOiPct:12.5,maxIgnition1hPct:64.35,observed24hPct:229.58,note:'첫 대폭등봉보다 첫 비정상 거래량 봉을 T0로 사용'}},
