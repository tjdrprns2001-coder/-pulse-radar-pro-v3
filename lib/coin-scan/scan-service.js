...
function baseItem(staged,ts){
  ...
  const item={symbol:row.symbol,baseAsset:row.baseAsset,category:c.category,sector,priority:c.priority,dataState:c.dataState,reasons:c.reasons,structure:'neutral',momentum:'neutral',tfState:{},preSurge:null,candidateScore:fast.candidateScore,tradeSignal,updatedAt:ts};
