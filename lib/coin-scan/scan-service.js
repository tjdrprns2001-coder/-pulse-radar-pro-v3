...
function createScanService({provider,now=()=>Date.now(),performanceRecorder=null,alertRecorder=null,transitionSnapshotRecorder=null,recommendationHistory=null,marketValidationStore=null,marketValidationPerformance=null}={}){
  ...
  async function getMarketValidationStats(){return marketValidationPerformance&&typeof marketValidationPerformance.getStats==='function'?marketValidationPerformance.getStats({refresh:false}):{version:'MARKET_VALIDATION_STATS_v1',overall:{sampleCount:0,horizons:{}},byStatus:{},validationLift:{},falseRejection:{}}}
