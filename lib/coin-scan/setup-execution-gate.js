...
function apply({item,frames={},execution={},spot15m=[],intelligence=null,eventRisk=null,sequenceGap=null,feeBps=4}={}){
  ...
  const seqGap=sequenceGap==null?fresh.sequenceGap:Boolean(sequenceGap);
