...
function analyzeDeep(input={}){
  ...
  return{
    ...
    takerRatio,volumeAcceleration,oiChangePct,fundingPct,preSurge,tfState,pullback,reaccumulating,momentumSignals,reasons:reasons.slice(0,5),updatedAt:Date.now()
  };
}
