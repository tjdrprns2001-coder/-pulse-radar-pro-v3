...
function analyzeDeep(input={}){
  ...
  return{
    ...
    priceChange1h,priceChange15m,oiChangePct,fundingPct,preSurge,samplePattern,volumeShockMemory:samplePattern.volumeShockMemory,tfState,pullback,reaccumulating,momentumSignals,reasons:reasons.slice(0,8),updatedAt:Date.now()
  };
}
