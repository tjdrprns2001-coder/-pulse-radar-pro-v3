...
function analyzeDeep(input={}){
  ...
  return{
    ...
    takerRatio,volumeAcceleration,priceChange1h,priceChange15m,oiChangePct,fundingPct,preSurge,tfState,pullback,reaccumulating,momentumSignals,reasons:reasons.slice(0,5),updatedAt:Date.now()
  };
}

module.exports={TF_ORDER,metrics,indicatorSnapshot,combineMomentum,analyzeDeep};
