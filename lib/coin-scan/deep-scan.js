...
function analyzeDeep(input={}){
  ...
  return{
    ...
    priceChange1h,priceChange15m,oiChangePct,fundingPct,preSurge,samplePattern,tfState,pullback,reaccumulating,momentumSignals,reasons:reasons.slice(0,6),updatedAt:Date.now()
  };
}
